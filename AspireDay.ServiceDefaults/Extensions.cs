...
namespace AspireDay.ServiceDefaults;
...
public static class Extensions
{
    ...
    private static IHostApplicationBuilder AddServiceBus(this IHostApplicationBuilder builder)
    {
        builder.AddAzureServiceBusClient("aspiredaybus");
        return builder;
    }
